...
public class Achievement : MonoBehaviour
{
    ...
    {
        if (sliderCountScorpions.value == 5)
        {
            coins.numberCoins += 5;
        }
        else if (sliderCountScorpions.value == 10)
        {
    ...
    {
        if (sliderCountSpiders.value == 5)
        {
            coins.numberCoins += 6;
        }
        else if (sliderCountSpiders.value == 10)
        {
            coins.numberCoins += 11;
        }

    }
    public void AddCoinSnakes()
    {
        if (sliderCountSnakes.value == 5)
        {
            coins.numberCoins += 7;
        }
        else if (sliderCountSnakes.value == 10)
        {
            coins.numberCoins += 12;
        }
